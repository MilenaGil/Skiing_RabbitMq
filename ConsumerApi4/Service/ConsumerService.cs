...
namespace ConsumerApi4.Service
{
    public class ConsumerService : IHostedService
    {
        ...
        private void DoStuff()
        {
            ...
            _channel.QueueDeclare(queue: "QueueName4",
                                    durable: false,
                                    exclusive: false,
                                    autoDelete: false,
                                    arguments: null);

            _channel.QueueBind(queue: "QueueName4",
            ...
            _channel.BasicConsume(queue: "QueueName4", autoAck: false, consumerAsync);
        }
