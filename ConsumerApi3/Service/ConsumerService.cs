...
namespace ConsumerApi3.Service
{
    public class ConsumerService : IHostedService
    {
        ...
        private void DoStuff()
        {
            ...
            _channel.QueueDeclare(queue: "QueueName3",
                                    durable: false,
                                    exclusive: false,
                                    autoDelete: false,
                                    arguments: null);

            _channel.QueueBind(queue: "QueueName3",
            ...
            _channel.BasicConsume(queue: "QueueName3", autoAck: false, consumerAsync);
        }
